...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div class="container">
            ...
            <!-- Text Example -->
            <div class="verticalslider" id="textExample" style="height:850px;">
                ...
                <ul class="verticalslider_contents">
                    ...
                    <li style="padding-left:10px;">
                            ...
                            <fieldset style="height:60px;width:850px;">
                                ...
                                <div>
                                    <p><label for="input-one" class="float" style="padding-left:50px;width:150px;"><strong>Category Name:</strong></label>
                                        ...
                                        <input class="submit-button" type="submit" alt="SUBMIT" name="Submit" value="Add" style="width:80px; margin-top:-32px;margin-left: 550px;"/>
                                    </p>
                                </div>
                            </fieldset>
                        </form>
                        ...
                        <fieldset style="height:60px;width:850px;margin-left: 35px;">
                            ...
                            <div>
                                ...
                                <div style="height:50px;width:550px;margin-left:320px;margin-top:-30px;">
                                    <form action="AddSubCategory.action" >
                                        <p><label for="input-one" class="float" style="width:140px;"><strong>Sub Category Name:</strong></label>
                                            ...
                                            <input class="inp-text" name="name" type="text" size="30" style="width:160px;"/>
                                            <input class="submit-button" type="submit" alt="SUBMIT" name="Submit" value="Add" style="width:80px; margin-top:-32px;margin-left: 360px;"/>
                                        </p>
                                    </form>
                                </div>
                            </div>
                        ...
                        <fieldset style="height:360px;width:850px;margin-left: 35px;">
                            ...
                            <div>
                                ...
                                <div style="height:40px;width:560px;margin-left:450px;margin-top:-34px;">
                                    <p>
                                    <label for="input-one" class="float" style="width:150px;height:25px;margin-top: -1px;"><strong>Sub Category Name:</strong></label>
                                ...
                                <form action="AddItem.action">
                                    ...
                                    <div style="height:200px;width:800px;overflow:auto;margin-left:1%;">
                                        <style>
                                            .atable{
                                        ...
                                        <table class="atable" id="item_table">
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="text" size="15" name="unitPrice"/></td>
                                    ...
                                    <p style="padding-left:600px;padding-top:20px;">
                                        ...
                                        <input style="margin-top: -26px;margin-left: 80px;"class="submit-button" type="submit" alt="SUBMIT" name="Submit" value="Submit" onclick="setHiddenValues()"/>
                                    </p>
                                </form>
                            </div>
                        </fieldset>
                            ...
                            <fieldset style="height:500px;width:870px;margin-top: 10px;">
                                ...
                                <script type="text/javascript">
                                    function searchByCode(){
                                        ...
                                        var innerhtml = '<tr><td style="width:100px;height:40px;"><center>Category</center></td><td style="width:100px;height:40px;"><center>Sub Category</center></td><td style="width:100px;height:40px;"><center>Item Code</center></td><td style="width:100px;height:40px;"><center>Name</center></td><td style="width:100px;height:40px;"><center>Type</center></td><td style="width:100px;height:40px;"><center>Unit Price</center></td><td style="width:100px;height:40px;"><center>Re-Order</center></td></tr>';
                                        <s:iterator value="itemlist" var="item">
                                                if('${item.code}'.search(new RegExp(keyWord, 'i'))>=0){
                                                    innerhtml = innerhtml + '<tr><td style="width:100px;height:40px;"><center>${item.subCategory.category.name}</center></td><td style="width:100px;height:40px;"><center>${item.subCategory.name}</center></td><td style="width:100px;height:40px;"><center>${item.code}</center></td><td style="width:100px;height:40px;"><center>${item.name}</center></td><td style="width:100px;height:40px;"><center>${item.type}</center></td><td style="width:100px;height:40px;"><center>${item.unitPrice}</center></td><td style="width:100px;height:40px;"><center>${item.reorder}</center></td></tr>';
                                                }
                                        </s:iterator>
                                ...
                                <p><label for="input-one" class="float" style="padding-left:50px;width:120px;"><strong>Item Code:</strong></label>
                                    ...
                                    <input onclick="searchByCode()" class="submit-button" type="button" alt="SUBMIT" name="Submit" value="Search" style="width:80px; margin-top:-30px;margin-left: 550px;"/>
                                </p>
                                <p><label for="input-two" class="float" style="padding-left:50px;width:120px;"><strong>Item Name:</strong></label>
                                    ...
                                    <input onclick="searchByName()" class="submit-button" type="button" alt="SUBMIT" name="Submit" value="Search" style="width:80px; margin-top:-30px;margin-left: 550px;"/>
                                </p>
                                <p><label for="input-three" class="float" style="padding-left:50px;width:120px;"><strong>Item Type:</strong></label>
                                    ...
                                    <input onclick="searchByType()" class="submit-button" type="button" alt="SUBMIT" name="Submit" value="Search" style="width:80px; margin-top:-30px;margin-left: 550px;"/>
                                </p>
                                <ul>

                                </ul>

                                <div style="height:350px;width:860px;margin-left:5px;margin-top:10px;overflow: auto;">
                    ...
                    <li style="padding-left:10px;">
                        ...
                        <form action="EditItem.action">
                            ...
                            <fieldset style="height:500px;width:600px;margin-top:10px;">
                                        ...
                                        function category3OnChange(){
                                            ...
                                            <s:iterator value="itemlist" var="item">
                                                    if('${item.id}'==itemId){
                                                        ...
                                                        $('#editpurpose').val('${item.unitPrice}');
                                ...
                                <p><label for="input-seven" class="float"><strong>Unit Price:</strong></label>
                                <input class="inp-text" name="item.unitPrice" id="editpurpose" type="text" size="30"/></p>
                    ...
                    <li style="padding-left:10px;">
                        ...
                        <form action="#" method="post">
                            ...
                            <fieldset style="height:500px;width:880px;">
                                ...
                                <div style="height:450px;width:860px;margin-left:5px;margin-top:10px;overflow: auto;">
                                    <table width="840" border="1" style="background-color:#64B1FF;font-family:'Lucida Sans Unicode', 'Lucida Grande', sans-serif;color:#FFF;font-size:14px;font-weight:bold;-webkit-border-radius:5px;">
                                        <tr>
                                            <td style="width:100px;height:40px;"><center>Category</center></td>
                                            <td style="width:100px;height:40px;"><center>Sub Category</center></td>
                                            <td style="width:90px;height:40px;"><center>Item Code</center></td>
                                            <td style="width:140px;height:40px;"><center>Name</center></td>
                                            <td style="width:40px;height:40px;"><center>Type</center></td>
                                            <td style="width:100px;height:40px;"><center>Unit Price</center></td>
                                            <td style="width:60px;height:40px;"><center>Re-Order</center></td>
                                        ...
                                        <s:iterator value="itemlist" var="item">
                                            <tr>
                                                ...
                                                <td style="width:100px;height:40px;">${item.unitPrice}</td>
                ...
                <div style="padding-top:750px;padding-left:290px;">
