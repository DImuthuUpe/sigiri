                ...
                <ul class="verticalslider_contents">
                    <li>
                        <div style="padding-top:10px;padding-left:150px;">
                            <fieldset style="height:30px;width:200px;">
                                <center>	
                                    <a href="ItemConfiguration.action" ><h2>Item Configuration</h2></a></center>
                            </fieldset>
                        </div>
                        <div style="margin-top:-115px;padding-left:400px;">
                            <fieldset style="height:30px;width:200px;">
                                <center>
                                    <a href="SupplierOrder.action" ><h2>Place Supplier Order</h2></a></center>
                            </fieldset>
                        </div>
                        <div style="margin-top:1px;padding-left:40px;">
                            <fieldset style="width: 700px;height: 400px;">
                                <center>
                                    <h2>Enter Supplier to the System</h2>
                                </center>
                                <p><h3>*Enter Supplier</h3></p>
                                <p>In this Web page can Enter a new Supplier for the system so operator can Enter a Purchase Order for
                                    Selected Supplier </p>
                                <p><h3>*Search Entered Supplier</h3></p>
                                <p>In this Web page can Search Entered Supplier of the System.
                                <p><h3>*Update Entered Supplier</h3></p>
                                <p>In this web page can Update Entered Supplier of the System. It is a advance feature of this system.
                                    so Operator can manage a Accurate details of Supplier.
                                <p><h3>*View All Entered Suppliers</h3></p>
                                <p>In this web page can View All the Suppliers so Operator can get details that how many Suppliers had dealt
                                    with the company.</p>
                            </fieldset>
                        </div>
                    </li>
                    ...
                    <li style="padding-left:10px;">
                        ...
                        <form action="" >
                            ...
                            <fieldset style="height:500px;width:870px;margin-top:10px;">
                                ...
                                <div style="height:200px;width:860px;margin-left:5px;margin-top:10px;">
                                    <table width="800" border="1" style="background-color:#64B1FF;font-family:'Lucida Sans Unicode', 'Lucida Grande', sans-serif;color:#FFF;font-size:14px;font-weight:bold;-webkit-border-radius:5px;">
                                        <tr>
                                            <td style="width:100px;height:40px;"><center>Name</center></td>
                                            <td style="width:100px;height:40px;"><center>Address</center></td>
                                            <td style="width:80px;height:40px;"><center>Tel</center></td>
                                            <td style="width:80px;height:40px;"><center>Fax</center></td>                                            
                                        ...
                                        <s:iterator value="list" var="supplier">
                                            <tr>
                                                ...
                                                <td style="width:80px;height:40px;"><s:property value="#supplier.telephone"/></td>
                                                <td style="width:80px;height:40px;"><s:property value="#supplier.fax"/></td>                                              
