                    ...
                    <ul class="verticalslider_contents">
                        <li style="padding-left:10px;margin-top: 10px; ">
                            ...
                            <form action="AddCustomer.action" method="post">
                                ...
                                <fieldset style="height:450px;width:800px;">
                                    <center><p><h2>Enter New Customer</h2></p></center>
                                    
                                    <p><h3>* Add New Customer to the Order</h3></p>
                                        <p>According to the records there are many customers. So In this web page
                                           you can Enter a new Customer to the System that you are using.
                                           So you can put Order to the selected Customer.</p>
                                    <p><h3>* Search Entered Customer</h3></p>
                                        <p>In this Web page you can Search Entered Customer by there Name and Address.
                                           So you can view there All details.</p>
                                    <p><h3>* Edit Entered Customer</h3></p>
                                        <p>In this Web page you can Edit there All details as You needed.
                                           It is advanced feature of this web site. so It will help for the Company Order Procedure.</p>
                                    <p><h3>* View Entered Customers List</h3></p>
                                        <p>In this web page You can get a All the details and how many customers had dealt with the Company.
                                           </p>
...
`                                            <tr>
                    ...
                    <div style="padding-top:600px;padding-left:290px;">
                        <fieldset style="height:35px;width:600px;">
                            <a href="CustomerOrder.action" ><h2>click here to Enter Place customer order</h2></a>
